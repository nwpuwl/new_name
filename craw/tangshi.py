...
raw_url='https://so.gushiwen.cn/gushi/tangshi.aspx'
...
title_file = open("../data/tangshi_title.txt", "w+")
...
for title in title_href_dic:
    ...
    if (len(result)) > 0 :
        book = open("../data/tangshi/"+title+'.txt', "w+")
